...
@section('content')
<div>
    <div class="w-full flex align-middle justify-end">
    ...
    <img src="/assets/events/{{ $event->image }}" class="w-full h-80 rounded-md bg-cover" alt="Event image">
    <div class="mt-5">
        <h1 class="text-4xl">{{ $event->title }}</h1>
        <p class="mt-3 text-gray-500">{{ $event->description }}</p>
    </div>
